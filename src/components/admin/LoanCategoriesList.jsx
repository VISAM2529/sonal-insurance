      ...
      <div className="hidden sm:block overflow-x-auto">
        <table className="w-full min-w-full divide-y divide-gray-200">
          <thead className="bg-gray-50">
            <tr>
              {['Category', 'Description', 'Products Count', 'Status', 'Display Order', 'Actions'].map((header, index) => (
    ...
    <div className="p-4 sm:p-6 max-w-7xl mx-auto">
      <div className="flex flex-col sm:flex-row justify-between items-center mb-6 sm:mb-10">
        <div className="w-full sm:w-auto text-center sm:text-left">
          <h1 className="text-2xl sm:text-3xl font-semibold text-gray-900 tracking-tight">Loan Categories</h1>
      ...
      <div className="bg-white rounded-xl shadow-lg border border-gray-100 overflow-hidden">
        ...
        <div className="block sm:hidden space-y-4 p-4">
          {categories.map((category) => (
            <div key={category._id} className="bg-gray-50 rounded-lg p-4 border border-gray-200">
              <div className="flex items-center justify-between mb-2">
                <div className="flex items-center">
                  <div className={`w-8 h-8 rounded-lg flex items-center justify-center mr-2 ${category.bgColor || 'bg-gray-100'}`}>
              ...
              <div className="text-xs text-gray-500 mb-2">Products: {category.productCount || 0}</div>
        ...
        {categories.length === 0 && !loading && (
          <div className="text-center py-12">
            <CreditCard className="mx-auto h-10 sm:h-12 w-10 sm:w-12 text-gray-400" />
